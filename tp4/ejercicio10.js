...
class Aeropuerto {
  ...
  const avion1 = new Avion('Boeing 474', 300, 'Mendoza, Argentina', [
    'Santi',
    'Facu',
    'Mene',
  ]);
  
  const avion2 = new Avion('MD-80', 220, 'Bs.As, Argentina', [
    'Noelia',
    'Federico',
  ]);
  
  const avion3 = new Avion('AirbusA380', 2, 'Paris, Francia', [
    'Tomas',
    'Madeo',
  ]);
  ...
  aeropuertoInter.buscarAvion('Boeing 474');
